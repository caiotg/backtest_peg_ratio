...
class ReportResult():
    ...
    def make_report(self):
        ...
        print(f'Retorno a.a. Modelo: {self.retornoAnoModelo * 100:.2f}%')
        print(f'Volatilidade Ultimo Ano: {self.volUltimoAno * 100:.2f}%')
        print(f'Indice Sharpe: {self.sharpe:.2f}')
        print(f'Turn over carteiras: {self.turnoverMedio * 100:.2f}%')
        ...
        print(f'Maior sequecia de vitorias: {self.maiorSequenciaVitorias}')
        print(f'Maior sequencia de derrotas: {self.maiorSequeciaDerrotas}')
